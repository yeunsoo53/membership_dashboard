        ...
        with open(csv_file_path, 'r', newline='', encoding='utf-8') as f:
            ...
            for row in reader:
                ...
                for key, value in row.items():
                    ...
                    if key in ['Name', 'UIN', 'Email', 'Score', 'Major']:
                        json_row[key] = value
                    elif key == 'Class':
                        grad_class = value.split()
                        if grad_class[0] == 'spring':
                            json_row['Grad Semester'] = 'Spring'
                        elif grad_class[0] == 'fall':
                            json_row['Grad Semester'] = 'Fall'
                        
                        json_row['Grad Year'] = int(grad_class[1])
                    else:
                        continue

                json_row['Admission'] = False
